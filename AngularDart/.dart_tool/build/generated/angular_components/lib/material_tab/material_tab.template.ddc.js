define(['dart_sdk', 'packages/angular_components/material_tab/material_tab.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_tab/material_tab', 'packages/angular_components/utils/id_generator/id_generator', 'packages/angular_components/content/deferred_content_aware', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/utils/id_generator/id_generator.template'], function(dart_sdk, material_tab$46scss$46css, view_type, change_detection, modules, material_tab, id_generator, deferred_content_aware, angular, deferred_content_aware$, focus, id_generator$) {
  ...
  dart.defineLazy(material_tab__material_tab$46template, {
    /*material_tab__material_tab$46template.MaterialTabComponentNgFactory*/get MaterialTabComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialTabComponent()).new("material-tab", dart.fn(material_tab__material_tab$46template.viewFactory_MaterialTabComponentHost0, AppViewAndintToAppView()), material_tab__material_tab$46template._MaterialTabComponentMetadata));
    },
