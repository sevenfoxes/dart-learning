define(['dart_sdk', 'packages/angular_components/material_select/material_select_searchbox.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_input/material_input.template', 'packages/angular_components/material_input/deferred_validator', 'packages/angular_forms/src/directives', 'packages/angular_components/material_input/material_input', 'packages/angular_components/material_input/material_input_default_value_accessor', 'packages/angular_components/utils/angular/reference/reference', 'packages/angular_components/focus/focus', 'packages/angular_components/material_input/base_material_input', 'packages/angular_components/material_select/material_select_searchbox', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/mixins/focusable_mixin.template', 'packages/angular_components/model/selection/select.template', 'packages/angular_components/utils/async/async.template', 'packages/angular_components/utils/browser/events/events.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, material_select_searchbox$46scss$46css, view_type, change_detection, modules, material_input, deferred_validator, directives, material_input$, material_input_default_value_accessor, reference, focus, base_material_input, material_select_searchbox, angular, focus$, focusable_mixin, select, async, events, angular_forms) {
  ...
  material_select__material_select_searchbox$46template._ViewMaterialSelectSearchboxComponentHost0 = class _ViewMaterialSelectSearchboxComponentHost0 extends src__core__linker__app_view.AppView {
    ...
    injectorGetInternal(token, nodeIndex, notFoundResult) {
      if (token === dart.wrapType(focus__focus.Focusable) && 0 === nodeIndex) {
  ...
  dart.defineLazy(material_select__material_select_searchbox$46template, {
    /*material_select__material_select_searchbox$46template.MaterialSelectSearchboxComponentNgFactory*/get MaterialSelectSearchboxComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialSelectSearchboxComponent()).new("material-select-searchbox", dart.fn(material_select__material_select_searchbox$46template.viewFactory_MaterialSelectSearchboxComponentHost0, AppViewAndintToAppView()), material_select__material_select_searchbox$46template._MaterialSelectSearchboxComponentMetadata));
    },
