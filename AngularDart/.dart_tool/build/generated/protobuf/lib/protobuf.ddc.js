define(['dart_sdk', 'packages/fixnum/fixnum'], function(dart_sdk, fixnum) {
  ...
  protobuf.CodedBufferWriter = class CodedBufferWriter extends core.Object {
    ...
    static _makeWriteFunctionMap() {
      ...
      _[$_set](protobuf.PbFieldType._INT32_BIT, makeWriter(dart.fn(protobuf.CodedBufferWriter._int32ToBytes, intToByteData())));
      ...
      _[$_set](protobuf.PbFieldType._UINT32_BIT, makeWriter(dart.fn(protobuf.CodedBufferWriter._toVarint32, intToByteData())));
      _[$_set](protobuf.PbFieldType._UINT64_BIT, makeWriter(dart.fn(protobuf.CodedBufferWriter._toVarint64, Int64ToByteData())));
  ...
  dart.setMethodSignature(protobuf.CodedBufferWriter, () => ({
    ...
    writeTo: dart.fnType(core.bool, [core.List$(core.int)], [core.int])
  }));
  ...
  protobuf.GeneratedMessage = class GeneratedMessage extends core.Object {
    ...
    mergeFromJson(data, extensionRegistry) {
      if (extensionRegistry === void 0) extensionRegistry = protobuf.ExtensionRegistry.EMPTY;
      let jsonMap = MapOfString$dynamic().as(convert.JSON.decode(data, {reviver: dart.fn(protobuf.GeneratedMessage._emptyReviver, dynamicAnddynamicTodynamic())}));
