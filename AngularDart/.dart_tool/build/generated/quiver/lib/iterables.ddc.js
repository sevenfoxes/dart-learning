define(['dart_sdk'], function(dart_sdk) {
  ...
  iterables$.merge = function(T, iterables, compare) {
    ...
    return core.Iterable$(T)._check(dart.test(iterables[$isEmpty]) ? const$ || (const$ = dart.constList([], core.Null)) : new (iterables$._Merge$(T)).new(iterables, dart.fnType(core.int, [T, T])._check(compare != null ? compare : dart.fn(core.Comparable.compare, ComparableAndComparableToint()))));
  };
