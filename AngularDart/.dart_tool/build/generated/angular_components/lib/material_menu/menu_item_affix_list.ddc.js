define(['dart_sdk', 'packages/angular_components/model/menu/menu_item_affix', 'packages/observable/observable', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/ui/icon', 'packages/angular_components/material_menu/menu_root'], function(dart_sdk, menu_item_affix, observable, change_detection, icon, menu_root) {
  'use strict';
