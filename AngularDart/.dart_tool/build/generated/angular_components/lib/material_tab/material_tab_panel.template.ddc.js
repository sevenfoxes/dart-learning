define(['dart_sdk', 'packages/angular_components/material_tab/material_tab_panel.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_tab/fixed_material_tab_strip.template', 'packages/angular_components/material_tab/fixed_material_tab_strip', 'packages/angular_components/material_tab/tab_change_event', 'packages/angular_components/material_tab/material_tab_panel', 'packages/angular_components/material_tab/material_tab', 'packages/angular_components/material_tab/material_tab.template', 'packages/angular/angular.template', 'packages/angular_components/material_tab/tab_change_event.template'], function(dart_sdk, material_tab_panel$46scss$46css, view_type, change_detection, modules, fixed_material_tab_strip, fixed_material_tab_strip$, tab_change_event, material_tab_panel, material_tab, material_tab$, angular, tab_change_event$) {
  ...
  dart.defineLazy(material_tab__material_tab_panel$46template, {
    /*material_tab__material_tab_panel$46template.MaterialTabPanelComponentNgFactory*/get MaterialTabPanelComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialTabPanelComponent()).new("material-tab-panel", dart.fn(material_tab__material_tab_panel$46template.viewFactory_MaterialTabPanelComponentHost0, AppViewAndintToAppView()), material_tab__material_tab_panel$46template._MaterialTabPanelComponentMetadata));
    },
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_tab_panel.template.dart"],"names":[],"mappings":";;;;QAyCa,IAAO;;;;QAX0C,oDAAO;;;;;;QAajD,iCAAO;;;;;;;;;;;;;;;;;;;;;MAbP,4EAAgC;YAAG,iBAAO,AAAQ,oDAAD,OAAO;;;;;;;;;;;;;AAkBxE,UAAM,UAAU,WAAM;AACtB,UAA0B,mBAAmB,iBAAY,CAAC,OAAO;AACjE,uBAAW,GAAG,IAAI,yFAA2C,CAAC,MAAM;AACpE,iBAAK,GAAG,iBAAW,OAAO;AAC1B,sBAAgB,SAAO,CAAC,WAAK;AAC7B,mBAAQ,CAZC,AAYA,IAZO,oBAYP,WAAK;AACd,+CAAmC,GAAG,IAAI,yEAAsC,CAAC,iBAAW,IAAI,mBAAE,eAAU,YAAY,CAAC,mCAAM,2CAAoB,CAAC,YAAU,aAAQ,YAAY,EAAE;AACpL,uBAAW,OAAO,CAAC,yCAAmC,EAAE;AACxD,kBAAO,CAAC,gBAAgB,EAAE;AAC1B,UAAM,iBAAiB,yCAAmC,gBAAgB,OAAO,CAAC,kBAAa,yGAAC,QAAG;AACnG,UAAM,iBAAiB,yCAAmC,UAAU,OAAO,CAAC,kBAAa,yGAAC,QAAG;AAC7F,eAAI,CAAC,yDAAU,CAAC,cAAc,EAAE,cAAc;AAC9C,YAAO;IACT;;AAIE,UAAwC,OAAO,QAAG;AAClD,UAAK,UAAU;AACf,aAAO,GAAG;AACV,UAAM,YAAY,IAAI,OAAO;AAC7B,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,iDAAmC,OAAO,GAAG,SAAS;AACtD,eAAO,GAAG;AACV,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,IAAI,eAAe;AACrC,YAAK,AAAU,aAAO,IAAE,SAAS,GAAG;AAClC,iDAAmC,eAAe,GAAG,SAAS;AAC9D,eAAO,GAAG;AACV,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,IAAI,UAAU;AAChC,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,iDAAmC,UAAU,GAAG,SAAS;AACzD,eAAO,GAAG;AACV,qBAAO,GAAG,SAAS;;AAErB,UAAI,OAAO,EAAE;AACX,yBAAW,gBAAgB;;AAE7B,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;IACb;;6FAvD+B,UAA2B,EAAE,WAAe;IAP3D,WAAK;IACuB,iBAAW;IAChB,yCAAmC;IACtE,aAAO;IACP,aAAO;IACP,aAAO;AAEoE,wGAAM,qCAAgB,UAAU,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,UAAU;AAC7K,eAAM,GAAG,IAAO,oBAAP,AAAA,AAAQ,IAAD,SAAS,gBAAc,CAAC;AACxC,eAAM,UAAU,GAAG;AACnB,kGAAW;gBAAX,sFAAW,GAAK,AAAA,AAAQ,iCAAD,aAAa,iBAAiB,CAAC,IAAI,2CAAiB,SAAS,EAAE,4EAAgC;AACtH,2BAAkB,CAAC,sFAAW;EAChC;;;;;;;;;;4BAJW,IAAO;;;;;;;;MAFS,sFAAW;;;;;gGA2D0C,UAA2B,EAAE,WAAe;AAC5H,UAAO,KAAI,8EAA8B,CAAC,UAAU,EAAE,WAAW;EACnE;;MAEoB,gFAAoC;YAAG;;;;;;;AASvD,uBAAW,GAAG,IAAI,8EAA8B,CAAC,MAAM;AACvD,iBAAM,GAAG,iBAAW,OAAO;AAC3B,0CAA8B,GAAG,IAAI,8DAAiC,CAAC,iBAAW,IAAI;AACtF,0CAA8B,KAAK,GAAG;AACtC,uBAAW,OAAO,CAAC,oCAA8B,EAAE,qBAAgB;AACnE,gBAAK,CAAC,WAAM;AACZ,YAAO,KAAI,+CAA+C,CAAC,GAAG,MAAM,WAAM,EAAE,oCAA8B;IAC5G;;AAIE,UAAK,UAAU;AACf,UAAK,aAAc,YAAY,KAAI;AACnC,UAAI,OAAO,EAAE;AACX,yBAAW,gBAAgB;;AAE7B,UAAI,UAAU,EAAE;AACd,4CAA8B,mBAAmB;;AAEnD,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;IACb;;kGA5BoC,UAA2B,EAAE,WAAe;IAHjD,iBAAW;IACR,oCAA8B;IAC3D,4BAAsB,GAAG;AACsD,6GAAM,qCAAgB,KAAK,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;EAAC;;;;;;;;;;;;;;oGA+BjI,UAA2B,EAAE,WAAe;AAC7F,UAAO,KAAI,mFAAmC,CAAC,UAAU,EAAE,WAAW;EACxE;;MAE0D,8EAAkC;YAAG,gBAAM,mDAAmD,CAAC,sBAAsB,yHAA0C,EAAE,8EAAkC;;MACvP,8EAAkC;YAAG;;MACvC,oDAAQ;YAAG;;;;;AAEb,kBAAI,oDAAQ,GAAE;AACZ;;AAEF,2DAAW;AAEX,IAAO,oCAAiB,CAAC,yEAAyB,EAAE,8EAAkC;AACtF,IAAM,+DAAa;AACnB,IAAM,mDAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,uDAAa;EACrB","file":"material_tab_panel.template.ddc.js"}');
  // Exports:
  return {
