define(['dart_sdk', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/mixins/has_tab_index.template', 'packages/angular_components/utils/browser/events/events.template'], function(dart_sdk, directive_change_detector, button_decorator, angular, focus, has_tab_index, events) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["button_decorator.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;IAuBgC;;;;;;sBAKP,IAAqB,EAAE,EAAkB;AAC9D,UAAK,aAAc,IAAI,QAAQ,KAAI;AACnC,UAAI,UAAU,EAAE;AACd,cAAK,AAAU,aAAQ,KAAK,IAAE,OAAO;AACnC,sBAAO,CAAC,EAAE,EAAE,QAAQ,aAAQ,KAAK,gCAAb,aAAQ,KAAK;;;AAGrC,UAAM,YAAY,aAAQ,SAAS;AACnC,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,oBAAO,CAAC,EAAE,EAAE,YAAY,SAAS;AACjC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,aAAQ,YAAY;AACtC,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,oBAAO,CAAC,EAAE,EAAE,iBAAiB,SAAS,gCAAT,SAAS;AACtC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,aAAQ,SAAS;AACnC,YAAK,AAAU,aAAO,IAAE,SAAS,GAAG;AAClC,4BAAe,CAAC,EAAE,EAAE,eAAe,SAAS;AAC5C,qBAAO,GAAG,SAAS;;IAEvB;;oFAvBoB,QAAa;IAH7B,aAAO;IACP,aAAO;IACN,aAAO;IACa,eAAQ,GAAR,QAAQ;;EAAC;;;;;;;;;;;MA0BhC,sDAAQ;YAAG;;;;;AAEb,kBAAI,sDAAQ,GAAE;AACZ;;AAEF,6DAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,8CAAa;AACnB,IAAM,uDAAa;EACrB","file":"button_decorator.template.ddc.js"}');
  // Exports:
  return {
