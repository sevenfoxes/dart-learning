define(['dart_sdk', 'packages/angular_components/material_checkbox/material_checkbox.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/glyph/glyph.template', 'packages/angular_components/glyph/glyph', 'packages/angular_components/material_checkbox/material_checkbox', 'packages/angular_components/material_ripple/material_ripple.template', 'packages/angular_components/material_ripple/material_ripple', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/model/ui/icon.template', 'packages/angular_components/utils/browser/events/events.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, material_checkbox$46scss$46css, view_type, change_detection, modules, glyph, glyph$, material_checkbox, material_ripple, material_ripple$, angular, focus, icon, events, angular_forms) {
  ...
  dart.defineLazy(material_checkbox__material_checkbox$46template, {
    /*material_checkbox__material_checkbox$46template.MaterialCheckboxComponentNgFactory*/get MaterialCheckboxComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialCheckboxComponent()).new("material-checkbox", dart.fn(material_checkbox__material_checkbox$46template.viewFactory_MaterialCheckboxComponentHost0, AppViewAndintToAppView()), material_checkbox__material_checkbox$46template._MaterialCheckboxComponentMetadata));
    },
