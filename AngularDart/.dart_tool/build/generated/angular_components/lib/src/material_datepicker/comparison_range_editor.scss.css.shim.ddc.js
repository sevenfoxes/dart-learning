define(['dart_sdk', 'packages/angular_components/material_datepicker/calendar.template', 'packages/angular_components/material_datepicker/comparison.template', 'packages/angular_components/material_datepicker/range.template', 'packages/angular_components/model/date/date.template', 'packages/angular_components/model/observable/observable.template', 'packages/angular_components/src/material_datepicker/sequential.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_toggle/material_toggle.template', 'packages/angular_components/material_toggle/material_toggle', 'packages/angular_components/src/material_datepicker/comparison_range_editor', 'packages/angular_components/material_select/material_select_item.template', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular_components/material_select/activation_handler', 'packages/angular_components/material_select/material_select_item', 'packages/angular_components/model/selection/selection_container', 'packages/angular_components/model/ui/has_renderer', 'packages/angular/angular.template', 'packages/angular_components/material_datepicker/date_range_input.template', 'packages/angular_components/material_list/material_list.template', 'packages/angular_components/material_list/material_list_item.template', 'packages/angular_components/material_select/material_dropdown_select.template'], function(dart_sdk, calendar, comparison, range, date, observable, sequential, disposer, view_type, change_detection, modules, material_toggle, material_toggle$, comparison_range_editor, material_select_item, dom_service, material_dropdown_base, activation_handler, material_select_item$, selection_container, has_renderer, angular, date_range_input, material_list, material_list_item, material_dropdown_select) {
  ...
  dart.defineLazy(src__material_datepicker__comparison_range_editor$46scss$46css$46shim, {
    /*src__material_datepicker__comparison_range_editor$46scss$46css$46shim.styles*/get styles() {
      return dart.constList(["._nghost-%COMP% { display:flex; flex-direction:column; } .comparison-toggle-section._ngcontent-%COMP% { display:flex; justify-content:space-between; align-items:center; flex-grow:1; height:32px; padding:0 16px; } .comparison-toggle._ngcontent-%COMP% { display:inline-flex; } .comparison-option-dropdown._ngcontent-%COMP% { flex-grow:1; display:inline-block; padding:0 8px; position:relative; } material-select-item._ngcontent-%COMP% { font-size:inherit; } .fake-popup._ngcontent-%COMP% { background-color:#fff; left:0; position:absolute; top:0; z-index:1; }"], dart.dynamic);
    }
  });
  ...
  dart.defineLazy(src__material_datepicker__comparison_range_editor$46template, {
    /*src__material_datepicker__comparison_range_editor$46template.ComparisonRangeEditorComponentNgFactory*/get ComparisonRangeEditorComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfComparisonRangeEditorComponent()).new("comparison-range-editor", dart.fn(src__material_datepicker__comparison_range_editor$46template.viewFactory_ComparisonRangeEditorComponentHost0, AppViewAndintToAppView()), src__material_datepicker__comparison_range_editor$46template._ComparisonRangeEditorComponentMetadata));
    },
