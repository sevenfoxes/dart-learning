define(['dart_sdk', 'packages/angular_components/material_input/material_input.scss.css.shim', 'packages/angular_components/material_input/material_input_multiline.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_forms/src/directives', 'packages/angular_components/focus/focus', 'packages/angular_components/material_input/material_input_multiline', 'packages/angular_components/material_input/deferred_validator', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/utils/angular/reference/reference', 'packages/angular_components/material_input/base_material_input', 'packages/angular_components/material_input/base_material_input.template', 'packages/angular_components/material_input/deferred_validator.template', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/utils/angular/properties/properties.template', 'packages/angular_components/utils/angular/reference/reference.template', 'packages/angular_components/utils/browser/dom_service/angular_2.template', 'packages/angular_forms/angular_forms.template'], function(dart_sdk, material_input$46scss$46css, material_input_multiline$46scss$46css, view_type, change_detection, modules, directives, focus, material_input_multiline, deferred_validator, dom_service, reference, base_material_input, base_material_input$, deferred_validator$, angular, focus$, properties, reference$, angular_2, angular_forms) {
  ...
  material_input__material_input_multiline$46template.ViewMaterialMultilineInputComponent0 = class ViewMaterialMultilineInputComponent0 extends src__core__linker__app_view.AppView$(material_input__material_input_multiline.MaterialMultilineInputComponent) {
    build() {
      ...
      let _TemplateRef_16_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_16], dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponent1, AppViewAndintToAppViewOfMaterialMultilineInputComponent()));
    ...
    detectChangesInternal() {
      ...
      if (!core.identical(this[_expr_13], currVal_13)) {
        this.setProp(this[_el_11], "readOnly", currVal_13);
      ...
      let currVal_19 = !dart.test(_ctx.focused) || dart.test(_ctx.disabled);
  ...
  material_input__material_input_multiline$46template._ViewMaterialMultilineInputComponent1 = class _ViewMaterialMultilineInputComponent1 extends src__core__linker__app_view.AppView$(material_input__material_input_multiline.MaterialMultilineInputComponent) {
    build() {
      ...
      let _TemplateRef_1_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_1], dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponent2, AppViewAndintToAppViewOfMaterialMultilineInputComponent()));
      ...
      let _TemplateRef_2_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_2], dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponent3, AppViewAndintToAppViewOfMaterialMultilineInputComponent()));
      ...
      let _TemplateRef_3_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_3], dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponent4, AppViewAndintToAppViewOfMaterialMultilineInputComponent()));
      ...
      let _TemplateRef_4_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_4], dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponent5, AppViewAndintToAppViewOfMaterialMultilineInputComponent()));
  ...
  dart.defineLazy(material_input__material_input_multiline$46template, {
    /*material_input__material_input_multiline$46template.MaterialMultilineInputComponentNgFactory*/get MaterialMultilineInputComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialMultilineInputComponent()).new("material-input[multiline]", dart.fn(material_input__material_input_multiline$46template.viewFactory_MaterialMultilineInputComponentHost0, AppViewAndintToAppView()), material_input__material_input_multiline$46template._MaterialMultilineInputComponentMetadata));
    },
