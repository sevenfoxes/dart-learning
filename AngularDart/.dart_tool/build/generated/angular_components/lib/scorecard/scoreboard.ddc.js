define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/utils/color/palette', 'packages/angular_components/scorecard/scorecard', 'packages/intl/intl', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/src/scorecard/scorecard_bar', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, disposer, selection_model, palette, scorecard, intl, change_detection, scorecard_bar, dom_service) {
  ...
  dart.setGetterSignature(scorecard__scoreboard.ScoreboardComponent, () => ({
    ...
    scrollScorecardBarForward: core.String,
    scrollScorecardBarBack: core.String
  }));
  dart.setSetterSignature(scorecard__scoreboard.ScoreboardComponent, () => ({
    ...
    scorecardBar: src__scorecard__scorecard_bar.ScorecardBarDirective
  }));
