define(['dart_sdk', 'packages/angular_components/reorder_list/reorder_list.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/reorder_list/reorder_list', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/angular.template', 'packages/angular_components/reorder_list/reorder_events.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_components/utils/keyboard/keyboard.template'], function(dart_sdk, reorder_list$46scss$46css, view_type, change_detection, modules, reorder_list, ng_zone, angular, reorder_events, disposer, keyboard) {
  'use strict';
  ...
  reorder_list__reorder_list$46template.ViewReorderListComponent0 = class ViewReorderListComponent0 extends src__core__linker__app_view.AppView$(reorder_list__reorder_list.ReorderListComponent) {
    build() {
      ...
      this.ctx.placeholder = this[_el_0];
  ...
  dart.defineLazy(reorder_list__reorder_list$46template, {
    /*reorder_list__reorder_list$46template.ReorderListComponentNgFactory*/get ReorderListComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfReorderListComponent()).new("reorder-list", dart.fn(reorder_list__reorder_list$46template.viewFactory_ReorderListComponentHost0, AppViewAndintToAppView()), reorder_list__reorder_list$46template._ReorderListComponentMetadata));
    },
