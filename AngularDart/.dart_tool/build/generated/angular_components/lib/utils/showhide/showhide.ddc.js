define(['dart_sdk', 'packages/async/async', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, async, change_detection, dom_service) {
  ...
  utils__showhide__showhide.ShowHideDirective = class ShowHideDirective extends core.Object {
    ...
    set visible(value) {
      if (dart.test(this[_initialized])) {
        ...
        this[_domService].scheduleWrite(dart.fn(() => {
          this[_element][$classes].toggle(utils__showhide__showhide.ShowHideDirective._hideClass, !dart.test(value));
          this[_element][$classes].toggle(utils__showhide__showhide.ShowHideDirective._hiddenClass, !dart.test(value));
    ...
    [_show]() {
      ...
      this[_domService].scheduleRead(dart.fn(() => {
        if (dart.test(this[_initialWritePending]) || dart.test(this[_element][$classes].contains(utils__showhide__showhide.ShowHideDirective._hiddenClass))) {
          this[_domService].scheduleWrite(dart.fn(() => {
            this[_element][$classes].remove(utils__showhide__showhide.ShowHideDirective._hiddenClass);
          }, VoidToNull()));
    ...
    [_removeNgHide]() {
      ...
      this[_domService].scheduleWrite(dart.fn(() => {
        this[_element][$classes].remove(utils__showhide__showhide.ShowHideDirective._hideClass);
    ...
    [_hide]() {
      this[_hiding] = true;
      this[_domService].scheduleWrite(dart.fn(() => {
        this[_element][$classes].add(utils__showhide__showhide.ShowHideDirective._hideClass);
    ...
    [_hideIfHiding]() {
      if (dart.test(this[_hiding])) {
        this[_domService].scheduleWrite(dart.fn(() => {
          this[_element][$classes].add(utils__showhide__showhide.ShowHideDirective._hiddenClass);
        }, VoidToNull()));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["showhide.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAuCI,wBAAY,GAAG;IACjB;;AAIE,uBAAW;IACb;;YAI8B,cAAO,OAAO;;;YAKd,cAAO,OAAO;;;YAKX,iBAAU,OAAO;;;YAKjB,iBAAU,OAAO;;gBAItC,KAAU;AACpB,oBAAI,kBAAY,GAAE;AAChB,uBAAK,IAAG,WAAK,KAAK,WAAK;aAClB;AACL,kCAAoB,GAAG;AACvB,yBAAW,cAAc,CAAC;AACxB,wBAAQ,UAAQ,OAAO,CAAC,sDAAU,EAAE,WAAC,KAAK;AAC1C,wBAAQ,UAAQ,OAAO,CAAC,wDAAY,EAAE,WAAC,KAAK;AAC5C,oCAAoB,GAAG;;;IAG7B;;AAGE,uBAAW;AACX,uBAAW,aAAa,CAAC;AACvB,sBAAI,0BAAoB,eAAI,cAAQ,UAAQ,SAAS,CAAC,wDAAY,IAAG;AACnE,2BAAW,cAAc,CAAC;AACxB,0BAAQ,UAAQ,OAAO,CAAC,wDAAY;;AAKtC,2BAAW,UAAU,KAAK,YAAC,QAAC,CAAC;AAC3B,+BAAa;;eAEV;AACL,6BAAa;;;IAGnB;;AAGE,oBAAI,aAAO,GAAE;AACb,uBAAW,cAAc,CAAC;AACxB,sBAAQ,UAAQ,OAAO,CAAC,sDAAU;AAClC,qBAAO,IAAI,CAAC,cAAQ;;AAEtB,4BAAgB,CAAC;AACf,wBAAU,IAAI,CAA