define(['dart_sdk', 'packages/collection/collection'], function(dart_sdk, collection) {
  ...
  let EventSinkOfResultToEventSink = () => (EventSinkOfResultToEventSink = dart.constFn(dart.fnType(async.EventSink, [EventSinkOfResult()])))();
  ...
  src__typed__future.TypeSafeFuture$ = dart.generic(T => {
    ...
    dart.setMethodSignature(TypeSafeFuture, () => ({
      ...
      then: dart.gFnType(S => [async.Future$(S), [dart.fnType(dart.dynamic, [T])], {onError: core.Function}]),
  ...
  src__result__capture_transformer.CaptureStreamTransformer$ = dart.generic(T => {
    ...
    class CaptureStreamTransformer extends async.StreamTransformerBase$(T, src__result__result.Result$(T)) {
      bind(source) {
        ...
        return StreamOfResultOfT().eventTransformed(source, dart.fn(src__result__capture_transformer.CaptureStreamTransformer._createSink, EventSinkOfResultToEventSink()));
      }
      static _createSink(sink) {
