define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/angular_components/model/ui/has_renderer', 'packages/angular_components/utils/angular/properties/properties', 'packages/angular_components/model/selection/selection_model', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular_components/model/a11y/active_item_mixin', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/model/selection/selection_container', 'packages/angular_components/model/ui/has_factory', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_select/activation_handler', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular_components/utils/browser/dom_service/dom_service'], function(dart_sdk, disposer, has_renderer, properties, selection_model, button_decorator, active_item_mixin, change_detection, selection_container, has_factory, modules, activation_handler, material_dropdown_base, dom_service) {
  ...
  (material_select__material_select_item.MaterialSelectItemComponent.new = function(element, domService, dropdown, activationHandler, cdRef, role) {
