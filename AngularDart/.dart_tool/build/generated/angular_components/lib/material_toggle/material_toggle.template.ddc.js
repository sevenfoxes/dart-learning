define(['dart_sdk', 'packages/angular_components/material_toggle/material_toggle.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_toggle/material_toggle', 'packages/angular/angular.template', 'packages/angular_components/utils/browser/events/events.template'], function(dart_sdk, material_toggle$46scss$46css, view_type, change_detection, modules, material_toggle, angular, events) {
  'use strict';
  ...
  dart.defineLazy(material_toggle__material_toggle$46template, {
    /*material_toggle__material_toggle$46template.MaterialToggleComponentNgFactory*/get MaterialToggleComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialToggleComponent()).new("material-toggle", dart.fn(material_toggle__material_toggle$46template.viewFactory_MaterialToggleComponentHost0, AppViewAndintToAppView()), material_toggle__material_toggle$46template._MaterialToggleComponentMetadata));
    },
