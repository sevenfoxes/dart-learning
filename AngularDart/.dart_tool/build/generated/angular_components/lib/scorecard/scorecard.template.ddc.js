define(['dart_sdk', 'packages/angular_components/scorecard/scorecard.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/scorecard/scorecard', 'packages/angular_components/material_ripple/material_ripple.template', 'packages/angular_components/material_ripple/material_ripple', 'packages/angular_components/material_icon/material_icon.template', 'packages/angular_components/material_icon/material_icon', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular/angular.template', 'packages/angular_components/focus/keyboard_only_focus_indicator.template', 'packages/angular_components/utils/browser/dom_service/dom_service.template', 'packages/angular_components/utils/browser/events/events.template', 'packages/angular_components/utils/color/color.template', 'packages/angular_components/utils/color/palette.template'], function(dart_sdk, scorecard$46scss$46css, view_type, change_detection, modules, scorecard, material_ripple, material_ripple$, material_icon, material_icon$, dom_service, angular, keyboard_only_focus_indicator, dom_service$, events, color, palette) {
  ...
  scorecard__scorecard$46template.ViewScorecardComponent0 = class ViewScorecardComponent0 extends src__core__linker__app_view.AppView$(scorecard__scorecard.ScorecardComponent) {
    build() {
      ...
      let _TemplateRef_6_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_6], dart.fn(scorecard__scorecard$46template.viewFactory_ScorecardComponent3, AppViewAndintToAppViewOfScorecardComponent()));
      ...
      let _TemplateRef_7_8 = new src__core__linker__template_ref.TemplateRef.new(this[_appEl_7], dart.fn(scorecard__scorecard$46template.viewFactory_ScorecardComponent5, AppViewAndintToAppViewOfScorecardComponent()));
  ...
  dart.defineLazy(scorecard__scorecard$46template, {
    /*scorecard__scorecard$46template.ScorecardComponentNgFactory*/get ScorecardComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfScorecardComponent()).new("acx-scorecard", dart.fn(scorecard__scorecard$46template.viewFactory_ScorecardComponentHost0, AppViewAndintToAppView()), scorecard__scorecard$46template._ScorecardComponentMetadata));
    },
