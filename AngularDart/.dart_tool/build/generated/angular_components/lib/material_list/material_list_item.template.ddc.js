define(['dart_sdk', 'packages/angular_components/material_list/material_list_item.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_list/material_list_item', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular/angular.template', 'packages/angular_components/button_decorator/button_decorator.template', 'packages/angular_components/mixins/material_dropdown_base.template', 'packages/angular_components/model/a11y/active_item_mixin.template', 'packages/angular_components/utils/browser/dom_service/dom_service.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, material_list_item$46scss$46css, view_type, change_detection, modules, material_list_item, dom_service, material_dropdown_base, angular, button_decorator, material_dropdown_base$, active_item_mixin, dom_service$, disposer) {
  ...
  material_list__material_list_item$46template.ViewMaterialListItemComponent0 = class ViewMaterialListItemComponent0 extends src__core__linker__app_view.AppView$(material_list__material_list_item.MaterialListItemComponent) {
    ...
    detectHostChanges(firstCheck) {
      ...
      let currVal_5 = this.ctx.disabled;
      if (!(this[_expr_5] == currVal_5)) {
        this.updateElemClass(this.rootEl, "disabled", currVal_5);
  ...
  dart.defineLazy(material_list__material_list_item$46template, {
    /*material_list__material_list_item$46template.MaterialListItemComponentNgFactory*/get MaterialListItemComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialListItemComponent()).new("material-list-item", dart.fn(material_list__material_list_item$46template.viewFactory_MaterialListItemComponentHost0, AppViewAndintToAppView()), material_list__material_list_item$46template._MaterialListItemComponentMetadata));
    },
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_list_item.template.dart"],"names":[],"mappings":";;;;QA4Ca,IAAO;;;QAX0C,qDAAO;;;;;QAajD,iCAAO;;;;;;;;;;;;;;;;;;;;;;MAbP,6EAAgC;YAAG,iBAAO,AAAQ,qDAAD,OAAO;;;;;;;;;;;;AAkBxE,UAAwC,OAAO,QAAG;AAClD,UAAM,UAAU,WAAM;AACtB,UAA0B,mBAAmB,iBAAY,CAAC,OAAO;AACjE,kBAAO,CAAC,gBAAgB,EAAE;AAC1B,eAAI,CAAC,uDAAU;AACf,aAAO,mBAAiB,CAAC,cAAc,kBAAa,CAZ3C,IAAO,kBAYqC,IAAI;AACzD,aAAO,mBAAiB,CAAC,cAAc,kBAAa,CAb3C,IAAO,kBAaqC,IAAI;AACzD,aAAO,mBAAiB,CAAC,SAAS,kBAAa,CAdtC,IAAO,QAAP,IAAO,uBAcgC,IAAI;AACpD,aAAO,mBAAiB,CAAC,YAAY,kBAAa,CAfzC,IAAO,QAAP,IAAO,0BAemC,IAAI;AACvD,YAAO;IACT;sBAEuB,UAAe;AACpC,UAAM,YAAY,QAAG,SAAS;AAC9B,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,oBAAO,CAAC,WAAM,EAAE,YAAY,SAAS;AACrC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,OAAO;AAC5B,YAAK,AAAU,aAAO,IAAE,SAAS,GAAG;AAClC,4BAAe,CAAC,WAAM,EAAE,UAAU,SAAS;AAC3C,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,KAAK;AAC1B,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,oBAAO,CAAC,WAAM,EAAE,QAAQ,SAAS,gCAAT,SAAS;AACjC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,YAAY;AACjC,WAAK,eAAU,aAAO,EAAE,SAAS,GAAG;AAClC,oBAAO,CAAC,WAAM,EAAE,iBAAiB,SAAS,gCAAT,SAAS;AAC1C,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,SAAS;AAC9B,YAAK,AAAU,aAAO,IAAE,SAAS,GAAG;AAClC,4BAAe,CAAC,WAAM,EAAE,eAAe,SAAS;AAChD,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,SAAS;AAC9B,YAAK,AAAU,aAAO,IAAE,SAAS,GAAG;AAClC,4BAAe,CAAC,WAAM,EAAE,YAAY,SAAS;AAC7C,qBAAO,GAAG,SAAS;;IAEvB;;8FAnD+B,UAA2B,EAAE,WAAe;IAPvE,aAAO;IACN,aAAO;IACR,aAAO;IACP,aAAO;IACN,aAAO;IACP,aAAO;AAEmE,yGAAM,qCAAgB,UAAU,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,UAAU;AAC7K,eAAM,GAAG,IAAO,oBAAP,AAAA,AAAQ,IAAD,SAAS,gBAAc,CAAC;AACxC,eAAM,UAAU,GAAG;AACnB,mGAAW;gBAAX,uFAAW,GAAK,AAAA,AAAQ,iCAAD,aAAa,iBAAiB,CAAC,IAAI,2CAAiB,SAAS,EAAE,6EAAgC;AACtH,2BAAkB,CAAC,uFAAW;EAChC;;;;;;;;;;;;;;;;;MAN2B,uFAAW;;;;;iGAuD0C,UAA2B,EAAE,WAAe;AAC5H,UAAO,KAAI,+EAA8B,CAAC,UAAU,EAAE,WAAW;EACnE;;MAEoB,iFAAoC;YAAG;;;;;;;AAQvD,uBAAW,GAAG,IAAI,+EAA8B,CAAC,MAAM;AACvD,iBAAM,GAAG,iBAAW,OAAO;AAC3B,0CAA8B,GAAG,IAAI,+DAAiC,CAAC,WAAM,6DAAE,gBAAgB,CAAS,kEAAU,EAAE,aAAQ,YAAY,yDAAG,gBAAgB,CAAU,4DAAc,EAAE,aAAQ,YAAY,EAAE,QAAO,MAAM;AACxN,uBAAW,OAAO,CAAC,oCAA8B,EAAE,qBAAgB;AACnE,gBAAK,CAAC,WAAM;AACZ,YAAO,KAAI,+CAA+C,CAAC,GAAG,MAAM,WAAM,EAAE,oCAA8B;IAC5G;;AAIE,UAAK,UAAU;AACf,UAAK,aAAc,YAAY,KAAI;AACnC,UAAI,OAAO,EAAE;AACX,yBAAW,gBAAgB;;AAE7B,uBAAW,kBAAkB,CAAC,UAAU;AACxC,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;AACX,0CAA8B,YAAY;IAC5C;;mGA1BoC,UAA2B,EAAE,WAAe;IAFjD,iBAAW;IACR,oCAA8B;AACoB,8GAAM,qCAAgB,KAAK,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;EAAC;;;;;;;;;;;;;qGA6BjI,UAA2B,EAAE,WAAe;AAC7F,UAAO,KAAI,oFAAmC,CAAC,UAAU,EAAE,WAAW;EACxE;;MAE0D,+EAAkC;YAAG,gBAAM,mDAAmD,CAAC,sBAAsB,0HAA0C,EAAE,+EAAkC;;MACvP,+EAAkC;YAAG;;MACvC,qDAAQ;YAAG;;;;;AAEb,kBAAI,qDAAQ,GAAE;AACZ;;AAEF,4DAAW;AAEX,IAAO,oCAAiB,CAAC,0EAAyB,EAAE,+EAAkC;AACtF,IAAM,gCAAa;AACnB,IAAM,2DAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,iEAAa;AACnB,IAAM,kDAAa;EACrB","file":"material_list_item.template.ddc.js"}');
  // Exports:
  return {
