define(['dart_sdk', 'packages/angular_components/material_yes_no_buttons/material_yes_no_buttons.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_yes_no_buttons/material_yes_no_buttons', 'packages/angular_components/material_button/material_button', 'packages/angular_components/material_spinner/material_spinner.template', 'packages/angular_components/material_spinner/material_spinner', 'packages/angular_components/material_button/material_button.template', 'packages/angular_components/theme/dark_theme', 'packages/angular_components/button_decorator/button_decorator', 'packages/angular/angular.template'], function(dart_sdk, material_yes_no_buttons$46scss$46css, view_type, change_detection, modules, material_yes_no_buttons, material_button, material_spinner, material_spinner$, material_button$, dark_theme, button_decorator, angular) {
  ...
  dart.defineLazy(material_yes_no_buttons__material_yes_no_buttons$46template, {
    /*material_yes_no_buttons__material_yes_no_buttons$46template.MaterialYesNoButtonsComponentNgFactory*/get MaterialYesNoButtonsComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialYesNoButtonsComponent()).new("material-yes-no-buttons", dart.fn(material_yes_no_buttons__material_yes_no_buttons$46template.viewFactory_MaterialYesNoButtonsComponentHost0, AppViewAndintToAppView()), material_yes_no_buttons__material_yes_no_buttons$46template._MaterialYesNoButtonsComponentMetadata));
    },
