define(['dart_sdk', 'packages/observable/observable', 'packages/angular_components/src/model/selection/interfaces/selectable'], function(dart_sdk, observable, selectable) {
  'use strict';
  ...
  src__model__selection__radio_group_single_selection_model.RadioGroupSingleSelectionModel$ = dart.generic(T => {
    ...
    (RadioGroupSingleSelectionModel.new = function(initialValue) {
      ...
      RadioGroupSingleSelectionModel.__proto__.new.call(this, SingleSelectionModelOfT()._check(SelectionModelOfT().withList({selectedValues: initialValue == null ? dart.constList([], T) : JSArrayOfT().of([initialValue])})));
  ...
  model__selection__selection_model.SelectableChangeNotifier$ = dart.generic(T => {
    ...
    dart.setGetterSignature(SelectableChangeNotifier, () => ({
      ...
      [_hasSelectableObservers]: core.bool,
      selectableChanges: async.Stream$(model__selection__selection_model.SelectableChangeRecord)
    }));
