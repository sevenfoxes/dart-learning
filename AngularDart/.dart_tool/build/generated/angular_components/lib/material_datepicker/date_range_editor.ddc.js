define(['dart_sdk', 'packages/angular_components/material_datepicker/preset', 'packages/angular_components/model/date/date', 'packages/angular_components/material_datepicker/calendar', 'packages/intl/intl', 'packages/angular_components/material_datepicker/range', 'packages/angular_components/model/date/date_formatter', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/focus/focus', 'packages/angular_components/src/material_datepicker/comparison_range_editor', 'packages/angular_components/src/laminate/popup/popup_hierarchy', 'packages/angular_components/utils/browser/dom_service/dom_service', 'packages/angular_components/src/utils/angular/managed_zone/managed_zone', 'packages/angular_components/material_datepicker/material_calendar_picker', 'packages/angular_components/material_datepicker/material_month_picker', 'packages/quiver/time', 'packages/angular_components/model/observable/observable', 'packages/angular_components/src/material_datepicker/sequential'], function(dart_sdk, preset, date, calendar, intl, range, date_formatter, change_detection, focus, comparison_range_editor, popup_hierarchy, dom_service, managed_zone, material_calendar_picker, material_month_picker, time, observable, sequential) {
  ...
  dart.setGetterSignature(material_datepicker__date_range_editor.DateRangeEditorComponent, () => ({
    ...
    navigateBeforeMsg: core.String,
    navigateNextMsg: core.String,
    clearRangeMsg: core.String,
    customRangeMsg: core.String,
    daysToTodayMsg: core.String,
    daysToYesterdayMsg: core.String,
    rangeDisabledTooltip: core.String
  }));
