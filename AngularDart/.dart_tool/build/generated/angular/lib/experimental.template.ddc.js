define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/bootstrap/run.template'], function(dart_sdk, angular, change_detection, modules, run) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["experimental.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;MAuBI,gCAAQ;YAAG;;;;;AAEb,kBAAI,gCAAQ,GAAE;AACZ;;AAEF,uCAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,gDAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,8DAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,qCAAa;EACrB","file":"experimental.template.ddc.js"}');
  // Exports:
  return {
