define(['dart_sdk', 'packages/angular_components/utils/browser/events/events', 'packages/angular/src/bootstrap/modules', 'packages/observable/observable', 'packages/angular_components/src/laminate/popup/dom_popup_source', 'packages/quiver/core', 'packages/angular_components/laminate/enums/alignment', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/utils/angular/reference/reference'], function(dart_sdk, events, modules, observable, dom_popup_source, core, alignment, change_detection, reference) {
  ...
  dart.setGetterSignature(src__laminate__popup__popup_interface.PopupEvents, () => ({
    ...
    onOpen: async.Stream$(core$.Null),
    onClose: async.Stream$(core$.Null),
