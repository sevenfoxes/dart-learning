define(['dart_sdk', 'packages/angular_components/material_radio/material_radio_group.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_radio/material_radio', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/angular.template', 'packages/angular_components/focus/focus.template', 'packages/angular_components/model/selection/selection_model.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_forms/angular_forms.template', 'packages/angular_components/material_radio/material_radio.scss.css.shim', 'packages/angular_components/material_icon/material_icon.template', 'packages/angular_components/material_icon/material_icon', 'packages/angular_components/material_ripple/material_ripple.template', 'packages/angular_components/material_ripple/material_ripple', 'packages/angular_components/model/ui/icon.template', 'packages/angular_components/utils/browser/events/events.template'], function(dart_sdk, material_radio_group$46scss$46css, view_type, change_detection, modules, material_radio, ng_zone, angular, focus, selection_model, disposer, angular_forms, material_radio$46scss$46css, material_icon, material_icon$, material_ripple, material_ripple$, icon, events) {
  ...
  dart.defineLazy(material_radio__material_radio_group$46template, {
    /*material_radio__material_radio_group$46template.MaterialRadioGroupComponentNgFactory*/get MaterialRadioGroupComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialRadioGroupComponent()).new("material-radio-group", dart.fn(material_radio__material_radio_group$46template.viewFactory_MaterialRadioGroupComponentHost0, AppViewAndintToAppView()), material_radio__material_radio_group$46template._MaterialRadioGroupComponentMetadata));
    },
  ...
  dart.defineLazy(material_radio__material_radio$46template, {
    /*material_radio__material_radio$46template.MaterialRadioComponentNgFactory*/get MaterialRadioComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfMaterialRadioComponent()).new("material-radio", dart.fn(material_radio__material_radio$46template.viewFactory_MaterialRadioComponentHost0, AppViewAndintToAppView()), material_radio__material_radio$46template._MaterialRadioComponentMetadata));
    },
