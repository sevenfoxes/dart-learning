define(['dart_sdk', 'packages/crypto/crypto', 'packages/uuid/aes'], function(dart_sdk, crypto, aes) {
  'use strict';
  const core = dart_sdk.core;
  const math = dart_sdk.math;
  const dart = dart_sdk.dart;
  const dartx = dart_sdk.dartx;
  const src__sha256 = crypto.src__sha256;
  const aes$ = aes.aes;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["uuid_util.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;UAUgC,4CAAM;AAClC,UAAI,aAAM,IAAI,AAAI,eAAS,CAAC;AAE5B,UAAI,QAAQ,AAAC,IAAI,IAAI,OAAQ,AAAI,eAAM,KAAK,AAAI,eAAM,CAAC,IAAI;AAC3D,eAAQ,IAAI,GAAG,AAAE,CAAD,GAAG,IAAI,CAAC,IAAI;AAC1B,YAAI,CAAC,AAAE,CAAD,GAAG,OAAS,GAAG;AACnB,cAAI,GAAG,CAAoB,aAAnB,KAAK,WAAW,MAAK,mBAAkB,UAAQ;;AAEzD,SAAC,QAAC,CAAC,EAAI,gBAA0B,WAArB,WAAL,IAAI,SAAgB,CAAV,AAAE,CAAD,GAAG,MAAS,WAAK;;AAGrC,YAAO,EAAC;IACV;;AAME,UAAI,SAAS;AACb,UAAI,UAAU,AAAI,aAAI,CAAC,MAAM;AAE7B,UAAI,QAAQ,0BAAO;AACnB,aAAO,GAAG,kBAAM,QAAQ,CAAC,KAAK,OAAO,UAAQ,CAAC,GAAG,MAAM;AAEvD,YAAO,SAAG,OAAO,CAAC,OAAO,EAAE,QAAG,aAAa,CAAC,OAAO;IACrD;;;EACF","file":"uuid_util.ddc.js"}');
  // Exports:
  return {
    uuid_util: uuid_util
  };
