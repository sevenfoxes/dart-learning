define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/application_tokens'], function(dart_sdk, change_detection, application_tokens) {
  ...
  let AbstractControlToMapOfString$bool = () => (AbstractControlToMapOfString$bool = dart.constFn(dart.fnType(MapOfString$bool(), [src__model.AbstractControl])))();
  ...
  dart.defineLazy(src__directives__validators, {
    /*src__directives__validators.REQUIRED*/get REQUIRED() {
      return dart.fn(src__validators.Validators.required, AbstractControlToMapOfString$bool());
    }
  });
  ...
  src__model.ControlGroup = class ControlGroup extends src__model.AbstractControl$(core.Map$(core.String, dart.dynamic)) {
    ...
    [_anyControlsHaveStatus](status) {
      for (let name of this.controls[$keys]) {
        if (dart.test(this.contains(name)) && this.controls[$_get](name).status == status) return true;
      }
      return false;
    }
    [_allControlsHaveStatus](status) {
    ...
    [_reduceValue]() {
      ...
      for (let name of this.controls[$keys]) {
        if (dart.test(this[_included](name)) || dart.test(this.disabled)) {
  ...
  const _element$ = Symbol('_element');
  const Object_TouchHandler$$ = class Object_TouchHandler$0 extends core.Object {};
  (Object_TouchHandler$$.new = function() {
    src__directives__control_value_accessor.TouchHandler.new.call(this);
  }).prototype = Object_TouchHandler$$.prototype;
  dart.mixinMembers(Object_TouchHandler$$, src__directives__control_value_accessor.TouchHandler);
  const Object_ChangeHandler$$ = class Object_ChangeHandler$0 extends Object_TouchHandler$$ {};
  (Object_ChangeHandler$$.new = function() {
  ...
  const Object_TouchHandler$$0 = class Object_TouchHandler$1 extends core.Object {};
  ...
  const Object_ChangeHandler$$0 = class Object_ChangeHandler$1 extends Object_TouchHandler$$0 {};
  ...
  const Object_TouchHandler$$1 = class Object_TouchHandler$2 extends core.Object {};
  ...
  const Object_ChangeHandler$$1 = class Object_ChangeHandler$2 extends Object_TouchHandler$$1 {};
  ...
  const Object_TouchHandler$$2 = class Object_TouchHandler$3 extends core.Object {};
  ...
  const Object_ChangeHandler$$2 = class Object_ChangeHandler$3 extends Object_TouchHandler$$2 {};
  ...
  dart.setGetterSignature(src__directives__abstract_form.AbstractForm, () => ({
    ...
    ngSubmit: async.Stream$(src__model.ControlGroup),
    ngBeforeSubmit: async.Stream$(src__model.ControlGroup),
    formDirective: src__directives__form_interface.Form,
    control: src__model.ControlGroup,
    path: core.List$(core.String)
  }));
  ...
  dart.setMethodSignature(src__directives__ng_form.NgForm, () => ({
    ...
    findContainer: dart.fnType(src__model.ControlGroup, [core.List$(core.String)])
  }));
  ...
  dart.setSetterSignature(src__directives__ng_form.NgForm, () => ({
    __proto__: dart.getSetters(src__directives__ng_form.NgForm.__proto__),
    disabled: core.bool
  }));
  ...
  src__directives__memorized_form.MemorizedForm = class MemorizedForm extends src__directives__ng_form.NgForm {
    ...
    addControlGroup(dir) {
      ...
      async.scheduleMicrotask(dart.fn(() => {
        src__directives__shared.setUpControlGroup(src__model.ControlGroup._check(group), dir);
        group.updateValueAndValidity({emitEvent: false});
      }, VoidToNull()));
    }
    removeControl(ctrl) {
  ...
  dart.setFieldSignature(src__directives__ng_control_name.NgControlName, () => ({
    ...
    [_parent$0]: dart.finalFieldType(src__directives__control_container.ControlContainer),
