define(['dart_sdk', 'packages/angular_components/material_datepicker/date_range_input.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/material_input/material_input.template', 'packages/angular_components/material_input/deferred_validator', 'packages/angular_components/material_input/material_input', 'packages/quiver/time', 'packages/angular_components/material_datepicker/date_input', 'packages/angular_components/material_input/material_input_default_value_accessor', 'packages/angular_components/model/date/date', 'packages/angular_components/utils/angular/reference/reference', 'packages/angular_components/focus/focus', 'packages/angular_components/material_input/base_material_input', 'packages/angular_components/material_datepicker/date_range_input', 'packages/angular/angular.template', 'packages/angular_components/material_datepicker/calendar.template', 'packages/angular_components/material_datepicker/date_input.template', 'packages/angular_components/model/date/date.template', 'packages/angular_components/model/observable/observable.template'], function(dart_sdk, date_range_input$46scss$46css, view_type, change_detection, modules, material_input, deferred_validator, material_input$, time, date_input, material_input_default_value_accessor, date, reference, focus, base_material_input, date_range_input, angular, calendar, date_input$, date$, observable) {
  ...
  dart.defineLazy(material_datepicker__date_range_input$46template, {
    /*material_datepicker__date_range_input$46template.DateRangeInputComponentNgFactory*/get DateRangeInputComponentNgFactory() {
      return dart.const(new (ComponentFactoryOfDateRangeInputComponent()).new("date-range-input", dart.fn(material_datepicker__date_range_input$46template.viewFactory_DateRangeInputComponentHost0, AppViewAndintToAppView()), material_datepicker__date_range_input$46template._DateRangeInputComponentMetadata));
    },
